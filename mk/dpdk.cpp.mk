...
DPDK_CXXFLAGS = -I$(DPDK_PATH)/include -m64 -mssse3
DPDK_LDFLAGS = \
	-Wl,--no-as-needed \
	-Wl,-export-dynamic \
	-L$(DPDK_PATH)/lib \
	...
	-lrte_cfgfile -lrte_latencystats \
	...
	-lrte_eventdev -lrte_metrics -lrte_pmd_skeleton_event -lrte_pmd_i40e \
	-lrte_timer \
	-lrte_hash -lrte_net -lrte_vhost \
	-lrte_pmd_af_packet \
	-lrte_ip_frag -lrte_pdump -lrte_pmd_tap \
